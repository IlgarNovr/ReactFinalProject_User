...
function Footer() {
    ...
    return (
        <footer className="mt-5 footer appear-animate fadeIn appear-animation-visible" style={{animationDuration: "1.2s"}}>
                                    ...
                                    <div className="widget">
                                        ...
                                        <ul className="widget-body">
                                            <li><p className={"copyright"}><i className="d-icon-map" style={{
                                                color: "white",
                                                marginRight: 5
                                            }}></i>{constantData?.find(item => item?.title === 'address')?.value}
                                            </p>
                                            </li>
                                            <li><p className={"copyright"}><i className="d-icon-phone" style={{
                                                color: "white",
                                                marginRight: 5
                                            }}></i>{constantData?.find(item => item?.title === 'phone_number')?.value}
                                            </p>
                                            </li>
                                            <li><p className={"copyright"}><i className="d-icon-instagram" style={{
                                                color: "white",
                                                marginRight: 5
                                            }}></i>{constantData?.find(item => item?.title === 'instagram_address')?.value}
                                            </p>
                                            </li>
                                        </ul>
                                    </div>
